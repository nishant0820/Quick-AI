            ...
            <div className="flex flex-col md:flex-row justify-between w-full gap-10 border-b border-gray-500/30 pb-6">
                <div className="md:max-w-96">
                    ...
                    <p className="mt-6 text-sm">
                        Experience the power of AI with Quick AI. <br />Our platform offers a suite of tools designed to enhance your content creation process, from writing and editing to image generation and optimization. Join us today and transform your creative workflow.
                    </p>
                </div>
